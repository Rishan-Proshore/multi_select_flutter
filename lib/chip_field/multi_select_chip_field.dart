...
class __MultiSelectChipFieldViewState<V> extends State<_MultiSelectChipFieldView<V>> {
  ...
  void initState() {
    ...
    if (widget.scrollControl != null && widget.scroll) WidgetsBinding.instance.addPostFrameCallback((_) => _scrollToPosition());
  }
                              ...
                              : Padding(
                                  ...
                                  child: widget.title != null
                                      ? Text(
                                          widget.title!.data!,
                                          style: TextStyle(
                                              color: widget.title!.style != null ? widget.title!.style!.color : null, fontSize: widget.title!.style != null ? widget.title!.style!.fontSize ?? 18 : 18),
                                        )
                                      : Text(
                                          "Select",
                          ...
                          ? Scrollbar(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (ctx, index) {
                                  return widget.itemBuilder != null ? widget.itemBuilder!(_items[index] as MultiSelectItem<V>, widget.state!) : _buildItem(_items[index] as MultiSelectItem<V>);
                                },
                              ),
                            )
                          : ListView.builder(
                  ...
                  : Container(
                      ...
                      child: Wrap(
                        children: widget.itemBuilder != null
                            ? _items.map((item) => widget.itemBuilder!(item as MultiSelectItem<V>, widget.state!)).toList()
      ...
      child: ChoiceChip(
        shape: widget.chipShape as OutlinedBorder? ??
            RoundedRectangleBorder(
              side: BorderSide(
                  color: widget.colorator != null && widget.colorator!(item.value) != null && _selectedValues.contains(item.value)
